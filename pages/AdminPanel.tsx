      ...
      <main className="flex-grow">
        <div className="bg-white shadow">
          <div className="container mx-auto px-4 py-4">
            <h1 className="text-2xl font-bold text-gray-900">⚙️ Admin Panel - Quản lý Giáo viên</h1>
            <p className="text-gray-600 mt-1">Quản lý mã xác thực và duyệt tài khoản giáo viên</p>
          </div>
        </div>
