...
import WordPressShortcodeModal from '../WordPressShortcodeModal';
      ...
      <div>
        ...
        <div className="mb-6">
          ...
          <SelectionStats 
            ...
            globalSelectedCounts={globalSelectedCounts}
          />
        </div>
    ...
    <div className="flex h-full bg-gray-50 relative">
      ...
      <div className="flex-1 md:pl-[300px]">
        ...
        <PrintDialog
          ...
          shuffleMcqOptions={shuffleMcqOptions}
          setShuffleMcqOptions={setShuffleMcqOptions}
        ...
        <main className="flex-1 p-4 sm:p-8 lg:p-10 overflow-y-auto pt-4">
          ...
          <ActionButtons
            getTotalSelectedCount={getTotalSelectedCount}
            handleOfflineExam={handleOfflineExam}
            handleOnlineExam={handleOnlineExam}
